...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  window.route = {
	    ...
	    article: function article(ctx, next) {
	  ...
	  window.render = {
	    content: function content(ctx, next) {
	      $('#content').attr('data-postid', ctx.partials.postid).empty().append(ctx.partials.content);
...
/***/ function(module, exports, __webpack_require__) {
	...
	VModel.mainNav = function (currentpage) {
	  return new Vue({
	    ...
	    directives: {
	      'nav-highlight': function navHighlight(val) {
	        if (!val) {
	          return false;
	        }
	        var el = this.el;
	...
	var editor = function editor() {
	  return new Vue({
	    ...
	    ready: function ready() {
	      ...
	      _this.editor = editor;
	      util.getCategoryList().then(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	util.getCategoryList = function () {
	  return new Promise(function (resolve, reject) {
	    util.getJSON(constant.API.CATEGORY).done(function (res) {
	      resolve(res);
	    }).fail(function (xhr) {
	      reject(xhr);
	    });
	...
	util.createPost = function (post) {
	  ...
	  return new Promise(function (resolve, reject) {
	    util.postJSON(constant.API.POSTS, post).done(function (res) {
	      resolve(res);
	    }).fail(function (xhr) {
	      reject(xhr);
	    });
